...
- **More → Open Mission Control** opens Mission Control so you can click `+` if you need to create a space manually (Apple removed the programmatic-add private API on Tahoe — see [Tahoe findings](#tahoe-private-api-findings)).
